...
namespace WindowsFormsApp1.Forms
{
    public partial class FormPhong : Form
    {
        ...
        private void FormPhong_Load(object sender, EventArgs e)
        {
            ...
            dsPhong = obj.GetDataSetTable("Phong");
            // lay Ds de phuc vu sau 
            //đưa dữ liệu lên dataGridView.
            dataGridView1.DataSource = dsPhong.Tables[0];
            // dua len cbo Lop 3 buoc 
            Phong = obj.getDataTable("Phong");
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            txtMaPK.Clear();
            txtMaNV.Clear();
            dataGridView1.DataSource = dsPhong.Tables["Phong"];
        }
        ...
        private void btnTim_Click(object sender, EventArgs e)
        {
            ...
            tbl = obj.Get1Phong(strGiaTriTim);
